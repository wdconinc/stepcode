...
#define REN_destroy(x)  ALLOC_destroy(&REN_fl,(Freelist *)(Generic)x)
#define SCOPE_new() (struct Scope_ *)ALLOC_new(&SCOPE_fl)
#define SCOPE_destroy(x)    ALLOC_destroy(&SCOPE_fl,(Freelist *)(Generic)x)
#define SCHEMA_new()    (struct Schema_ *)ALLOC_new(&SCHEMA_fl)
#define SCHEMA_destroy(x)   ALLOC_destroy(&SCHEMA_fl,(Freelist *)(Generic)x)
...
extern SC_EXPRESS_EXPORT Variable VARfind PROTO( ( Scope, char * ) );
